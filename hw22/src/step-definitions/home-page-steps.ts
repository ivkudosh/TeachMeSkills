...
Then(/^the user waits until search input element is displayed on "Home" page$/, async () => {
    logger.info(`Waiting until search input element is displayed on ${Pages.HOME} page...`);
